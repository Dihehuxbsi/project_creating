...
while True:
    ...
    available_models = {}
    for model, price in car_models.items():
        if price <= budget:
            available_models[model] = price
    ...
    while True:
        ...
        print("Отличный выбор! Вы выбрали car_brand {car_model} за {available_models[car_model]} долларов. Поздравляем вас с покупкой! Наслаждайтесь ездой.")
        break
